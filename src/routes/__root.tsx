...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A confidential digital sanctuary for confession, prayer requests, pastoral counseling, testimony and supervised restoration." },
      { name: "author", content: "The Throne Room" },
      { property: "og:title", content: "The Throne Room" },
      { property: "og:description", content: "Enter holy ground. A confidential sanctuary for confession, prayer and pastoral care." },
